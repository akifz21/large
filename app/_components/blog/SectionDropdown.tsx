    ...
    <>
      <Menu as="div" className="relative inline-block z-0 text-left">
        ...
        >
          <Menu.Items
            static
            className="absolute -right-24 mt-2 w-56 top-8 origin-top-right divide-y divide-gray-100 rounded-md dark:bg-dark-color dark:ring-gray-950 p-2 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          >
